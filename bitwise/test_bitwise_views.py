...
class LogoutRouteTest(APITestCase):
    def test_logout_route(self):
        ...
        self.assertEqual(response.cookies['app-auth']['expires'], 'Thu, 01 Jan 1970 00:00:00 GMT')
        ...
        self.assertEqual(response.cookies['refresh-token']['expires'], 'Thu, 01 Jan 1970 00:00:00 GMT')
